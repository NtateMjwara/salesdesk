...
// ── Flash state (set by POST actions, read on GET) ──────────
...
<head>
  ...
  <title>Team — <?= htmlspecialchars($dealerName) ?> | SalesDesk</title>
...
<?php
// Render layout-app nav if it exists; otherwise minimal fallback.
$pageTitle   = 'Team';
$pageContent = '';
// Layout-app.php will be included by T1 — for now render inline.
?>
