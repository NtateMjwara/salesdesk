<?php
/**
 * SalesDesk — Public Layout Shell (v5.2)
 * T1 owns this file.
 *
 * Performance changes from v5.1:
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  <!--
    CSS load order (T1 rule — no team may alter this sequence):
      ...
      2. public.css            — public page components
      3. browse.css            — mega-nav panels + browse-page styles
      4. browse-additions.css  — utility classes + responsive additions
      5. mobile-hero-nav-fix.css — mobile nav + hero compact layout (v5.1)
