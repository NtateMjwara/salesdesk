<?php
/**
 * SalesDesk — Public Layout Shell (v5.1)
 * T1 owns this file.
 *
 * Changes from v5:
 *   MOB-1  Removed inline .pub-nav__inner override that set max-width:100%
 *          and killed the hamburger layout on mobile. browse.css + the new
 *          mobile-hero-nav-fix.css now own this rule.
 *   MOB-2  Removed inline .pub-page-wide override that set padding:0.
 *          public.css sets the correct padding; the fix sheet handles mobile.
 *   MOB-3  Removed inline .pub-breadcrumb override. mobile-hero-nav-fix.css
 *          handles max-width and spacing correctly.
 *
...
<head>
  ...
  <!--
    CSS load order (T1 rule — no team may alter this sequence):
      ...
      6. mobile-hero-nav-fix.css — mobile nav + hero compact layout (v5.1)
      7. how-it-works.css      — loaded always (low cost; avoids per-page logic)
      8. extraCss              — caller-injected page-specific sheet (if any)
  -->
...
<footer class="sd-footer">
  <div class="sd-footer__grid">
    ...
    <!-- Col 3: What We Offer -->
    <div class="sd-footer__col">
      <div class="sd-footer__col-title">What We Offer</div>
      <div class="sd-footer__links">
        <a href="how-it-works/brokers.php"  class="sd-footer__link">For Brokers</a>
        <a href="how-it-works/execs.php"    class="sd-footer__link">For Sales Executives</a>
        <a href="how-it-works/dealers.php"  class="sd-footer__link">For Dealers</a>
        <a href="/brokers.php"              class="sd-footer__link">Payout schedule</a>
        <a href="/dealers.php"              class="sd-footer__link">For Dealers</a>
        <a href="/about/saudi.php"          class="sd-footer__link">About SAUDI Group</a>
      </div>
    </div>
