    ...
    <div class="hws-adv-panel" id="hAdvPanel" aria-hidden="true">
      ...
      <div>
        ...
        <div class="hws-chip-row">
          ...
          <button class="hws-chip h-body-chip" data-val="SUV / 4x4"  type="button">🚐 SUV / 4x4</button>
...
var BODY_TYPES  = ['Bakkie','Crossover','Hatchback','MPV','SUV / 4x4','Sedan','Station Wagon','Convertible'];
var FUEL_TYPES  = ['Petrol','Diesel','Hybrid','Plug-in Hybrid','Electric'];
var PROVINCES   = [
